macro(a2x_build_manpage _depends_N _mps_N _mpt_N mversion)
    ...
    add_custom_command(
        ...
        COMMAND ${A2X} --asciidoc-opts="-a revnumber=${mversion}" -d manpage -f manpage -D ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR}/${_mps_N}
        DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${_mps_N})
    install(
